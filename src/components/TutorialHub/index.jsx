 ...
 * Each field is a card; each topic links to its own doc page.
 */
  ...
  return (
    <div className={styles.wrap}>
      <p className={styles.intro}>
        Pick a field, then click any topic to jump straight to its notes. Each topic has its
        own page — a growing library of everything I&rsquo;m learning on the quant path.
      </p>
